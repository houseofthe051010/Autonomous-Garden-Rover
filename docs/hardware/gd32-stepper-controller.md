...
See the [Raspberry Pi client instructions](../../legacy/raspberry-pi/gd32-stepper/README.md)
before wiring.
...
- [ESP32-P4 continuous and counted direct-motion handoff](../../firmware/gd32-stepper/README.md)
- [Legacy UART protocol and API](../protocols/gd32-stepper-uart-legacy.md)
- [Raspberry Pi 5 Thonny client](../../legacy/raspberry-pi/gd32-stepper/README.md)
- [Validated Pi 5 and GD32 working model](../../legacy/raspberry-pi/gd32-stepper/VALIDATED_WORKING_MODEL.md)
- [ESP32 MicroPython code](../../legacy/prototypes/esp32-micropython-gd32/README.md)
- [Earlier Ender firmware and flashing](../../legacy/prototypes/gd32-marlin-stepper/README.md)
