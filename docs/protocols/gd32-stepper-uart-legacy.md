...
[`../../legacy/raspberry-pi/gd32-stepper/stepper_controller.py`](../../legacy/raspberry-pi/gd32-stepper/stepper_controller.py).
Run it
with Thonny's Local Python 3 interpreter. The earlier ESP32 MicroPython client is
[`../../legacy/prototypes/esp32-micropython-gd32/main.py`](../../legacy/prototypes/esp32-micropython-gd32/main.py).
